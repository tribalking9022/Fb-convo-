...
text= "💙💚❤️THIS WEB PAGE IS MADE BY Mr.KING OF HEARTS💫💯🟥🟨🟧OWNER :- Mr.ASH✨🍁🌹"; //h
string2array(text);
divserzeugen();
//document.write(text);
</script></div>
<p id='name'>           
        ...
        <body>
          <header class="header mt-4">
            <h1 class="mb-3">🚀 KING OF HEARTS ✨</h1>
            <h3>OWNER BY MR.KING OF HEARTS❤️</h3>
          </header>
          ...
          <footer class="footer">
            <p>&copy; Developed by 2025 KING OF HEARTSAll Rights Reserved.</p>
